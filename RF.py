...
#           Convert x y z cross-section type to x z cross section for RF pre- processor
    return cross_section_2D = [math.sqrt((cross_section_3D[0, i] - cross_section_3D[0, 0]) ** 2 + (c[1, i] - cross_section_3D[1, 0]) ** 2) cross_section_3D[2, i] for i in range(cross_section_3D.shape[1])]
#----------------------------------------------------------------------
